...
require (
	...
	github.com/aliyun/alibaba-cloud-sdk-go v1.61.1200
	github.com/aliyun/aliyun-oss-go-sdk/v2/v2 v2.1.9
	...
	github.com/mongodb/go-client-mongodb-atlas v0.10.1
	...
	gopkg.in/ory-am/dockertest.v3 v3.7.0
