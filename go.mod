...
require (
	...
	github.com/aerospike/aerospike-client-go/v4 v4.3.0
	...
	github.com/hashicorp/hcl/v2/v2 v2.9.0
	github.com/hashicorp/nomad/api v0.12.10
	...
	github.com/michaelklishin/rabbit-hole/v2/v2 v2.6.0
	...
	gopkg.in/ory-am/dockertest.v3 v3.6.3
